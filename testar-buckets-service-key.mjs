// 🧪 TESTAR BUCKETS COM SERVICE KEY
// Script para verificar buckets usando a chave de serviço

import { createClient } from '@supabase/supabase-js';

// Usar a Service Key que tem mais permissões
const supabaseUrl = 'https://xwrnhpqzbhwiqasuywjo.supabase.co';
const supabaseServiceKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh3cm5ocHF6YndpcXFhc3V5d2pvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNTYwNzI3MCwiZXhwIjoyMDUxMTgzMjcwfQ.Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8';

const supabase = createClient(supabaseUrl, supabaseServiceKey);

console.log('🧪 TESTANDO BUCKETS COM SERVICE KEY');
...
// Executar teste
console.log('⏳ Iniciando teste com Service Key...');
testarBuckets();
